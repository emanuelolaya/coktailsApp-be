CREATE OR REPLACE PROCEDURE GET_RESOURCES_BY_COCKTAILS (
  ID_COCKTAIL_NUM IN NUMBER,
...
BEGIN
  OPEN COCKTAIL_CURSOR FOR
    SELECT
      ...
      CT.ID                                                  AS TIPS_ID,
      CT.NAME                                                AS TIPS_NAME,
      CT.DESCRIPTION                                         AS TIPS_DESCRIPTION,
      CASE
    ...
    FROM
      ...
      LEFT JOIN COCKTAIL__COCKTAIL_TIPS CCT ON CCT.ID_COCKTAIL = C.ID
      LEFT JOIN COCKTAIL_TIPS CT ON CT.ID = CCT.ID_COCKTAIL_TIPS
    WHERE C.ID = ID_COCKTAIL_NUM;
END GET_RESOURCES_BY_COCKTAILS;
